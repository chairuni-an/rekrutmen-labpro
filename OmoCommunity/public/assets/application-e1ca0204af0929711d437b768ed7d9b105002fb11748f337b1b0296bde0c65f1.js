...
CKEDITOR.editorConfig = function( config ) {
	config.removeButtons = 'Source,Save,Templates,NewPage,Preview,Print,Replace,Find,SelectAll,Scayt,PasteFromWord,HiddenField,ImageButton,RemoveFormat,Flash,Smiley,PageBreak,Iframe,About,Anchor,Language,BidiLtr,BidiRtl';
};
